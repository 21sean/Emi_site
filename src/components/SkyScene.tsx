 ...
 *
 * `celestial` toggles the sun/moon — set it false where a celestial body would
 * collide with foreground content (e.g. the home hero headshot) and only the
 * drifting clouds are wanted.
 */
export default function SkyScene({ celestial = true }: { celestial?: boolean }) {
  return (
    <div
      aria-hidden="true"
